...
<main>
        <div class="left_column">
            <div class ="Ingredient_card" id="Pepperoni">
        ...
        <div class="center_column">
            ...
            <div class="Canvas">
                ...
                <img id="img_Canadian_Bacon" class="hide Ingredient" src="Assets/Canadian_Bacon_topping.png"/>
                <img id="img_Peppers" class="hide Ingredient" src="Assets/Peppers_topping.png"/>
                <img id="img_Jalapeno" class="hide Ingredient" src="Assets/Jalapeno_topping.png"/>
                <img id="img_Pineapple" class="hide Ingredient" src="Assets/Pineapple_topping.png"/>
                <img id="img_Sausage" class="hide Ingredient" src="Assets/Sausage_topping.png"/>
                <img id="img_Pepperoni" class="hide Ingredient" src="Assets/Pepperoni_topping.png"/>
